...
By default, enabling this mode prevents periodic polls (i.e. what is specified using `--interval` or `--schedule`). To run periodic updates regardless, _additionally_ pass in the switch `--http-api-periodic-polls`.
